          ...
          <div className="flex flex-wrap">
            <div className="w-full lg:w-1/3 mb-16 lg:mb-0">
              ...
              <div className="w-36 mx-auto lg:mx-0 flex gap-2">
                <a
                  className="flex justify-center items-center w-10  h-10 p-2 bg-customDarkBg2 custom-border-gray  hover:bg-gray-700 rounded-xl"
            ...
            <div className="w-full lg:w-2/3  lg:pl-16 hidden lg:flex flex-wrap justify-between">
              <div className="w-full md:w-1/3 lg:w-auto mb-16 md:mb-0">
                ...
                <ul>
                  {FOOTER_DATA[0].items.map((item, i) => (
              ...
              <div className="w-full md:w-1/3 lg:w-auto mb-16 md:mb-0">
                ...
                <ul>
                  {FOOTER_DATA[1].items.map((item, i) => (
                    <li key={i} className="mb-4">
                      <a
                        className="text-gray-400 hover:text-gray-300"
                        href="#"
              ...
              <div className="w-full md:w-1/3 lg:w-auto">
                ...
                <ul>
                  {FOOTER_DATA[2].items.map((item, i) => (
                    <li key={i} className="mb-4">
                      <a
                        className="text-gray-400 hover:text-gray-300"
                        href="#"
